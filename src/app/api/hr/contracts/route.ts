...
export async function POST(req: NextRequest) {
  try {
    ...
    // Compuertas (regla institucional, 2026-07) — SOLO para docentes:
    //  1. Contrato de un docente → obligatorio asignarlo a un año académico.
    //  2. Y su vigencia completa debe caer DENTRO del período de ese año.
    // El staff no tiene ninguna de las dos restricciones (sus contratos
    // administrativos no siguen el calendario académico).
