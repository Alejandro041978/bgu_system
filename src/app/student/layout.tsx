...
import { CalendarDays, MessageCircle, LogOut, Award, ArrowLeft, Wallet, FileText, CalendarClock, PiggyBank, ClipboardList, Landmark, Gift, IdCard, MonitorCheck } from 'lucide-react'
    ...
    <div className="min-h-screen bg-gray-50 flex flex-col">
      ...
      <nav className="bg-white border-b border-gray-100 px-4">
        <div className="flex gap-1">
          ...
          <Link href="/student/profile" className="flex items-center gap-2 px-4 py-3 text-sm font-medium text-gray-600 hover:text-blue-600 border-b-2 border-transparent hover:border-blue-500 transition-colors">
            <IdCard className="w-4 h-4" /> Mis Datos
          </Link>
          ...
          <Link href="/student/campus-check" className="flex items-center gap-2 px-4 py-3 text-sm font-medium text-gray-600 hover:text-blue-600 border-b-2 border-transparent hover:border-blue-500 transition-colors">
            <MonitorCheck className="w-4 h-4" /> Verificar Campus
          </Link>
          ...
          <Link href="/student/president-letter" className="flex items-center gap-2 px-4 py-3 text-sm font-medium text-gray-600 hover:text-blue-600 border-b-2 border-transparent hover:border-blue-500 transition-colors">
            <Landmark className="w-4 h-4" /> USA President Letter
          </Link>
          <Link href="/student/referrals" className="flex items-center gap-2 px-4 py-3 text-sm font-medium text-gray-600 hover:text-blue-600 border-b-2 border-transparent hover:border-blue-500 transition-colors">
            <Gift className="w-4 h-4" /> Free Degree
          </Link>
