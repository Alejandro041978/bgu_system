...
export const ROUTE_TO_PAGE_KEY: [string, string][] = [
  ...
  ['/reports/carousel-audit', 'report_carousel_audit'],
  ...
  ['/academic/student-notifications', 'academic_student_notifications'],
  ...
  ['/academic/registry-audit', 'academic_registry_audit'],
  ['/academic/iw-activity', 'academic_iw_activity'],
  ...
  ['/finance/flywire-audit', 'finance_flywire_audit'],
  ...
  ['/academic/iw-reentry', 'academic_iw_reentry'],
  ...
  ['/academic/retakes', 'academic_retakes'],
  ['/admissions/upgrade-simulator', 'admissions_upgrade_simulator'],
  ...
  ['/campaigns/graduate-survey', 'campaign_survey_titulados'],
  ['/campaigns/employer-survey', 'campaign_survey_empleadores'],
...
export const API_ROUTE_TO_PAGE_KEY: [string, string][] = [
  ...
  ['/api/academic/retakes', 'academic_retakes'],
  ['/api/admissions/upgrade-simulator', 'admissions_upgrade_simulator'],
  ...
  ['/api/academic/student-notifications', 'academic_student_notifications'],
  ...
  ['/api/finance/flywire-audit', 'finance_flywire_audit'],
  ['/api/academic/iw-reentry', 'academic_iw_reentry'],
  ...
  ['/api/reports/carousel-audit', 'report_carousel_audit'],
  ...
  ['/api/academic/grade-status', 'academic_grades'],  ['/api/academic/assignments', 'academic_teaching'],
  ...
  ['/api/campaigns/detail/survey_titulados', 'campaign_survey_titulados'],
  ['/api/campaigns/survey-results', 'campaign_survey_titulados'],
  ['/api/campaigns/detail/survey_empleadores', 'campaign_survey_empleadores'],
  ['/api/campaigns/employer-survey-results', 'campaign_survey_empleadores'],
