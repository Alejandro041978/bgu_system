      ...
      {res && (
        <>
          ...
          <p className="text-[11px] text-gray-400">
            ...
            {res.resumen.sin_periodo > 0 && ` ${res.resumen.sin_periodo} calificación(es) quedaron fuera porque su fila no dice a qué semestre pertenece: las de Moodle no traen periodo y parte de las de SystemActiva llegaron como "1", "2" o "3". Sin filtro de periodo sí entran.`}
          </p>
