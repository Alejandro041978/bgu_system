...
const PAGE_GROUPS = [
  {
    ...
    pages: [
      ...
      { key: 'report_moodle_status', label: 'Reportes · Estado del Campus' },
      ...
      { key: 'academic_classroom_links', label: 'Académico · Vinculación de Aulas' },
  ...
  },
  {
    ...
    pages: [
      ...
      { key: 'academic_moodle_enrolments', label: 'Aulas en Moodle (accesos del estudiante)' },
      { key: 'academic_student_audit', label: 'Cambios en las Fichas' },
      { key: 'academic_student_notifications', label: 'Notificaciones al estudiante' },
      ...
      { key: 'academic_registry_audit', label: 'Auditor del Registro' },
      { key: 'academic_iw_activity', label: 'Efectividad de los IW' },
  ...
  },
  {
    ...
    pages: [
      ...
      { key: 'academic_iw_reentry', label: 'Académico · Gestor IW / Re-Entry' },
