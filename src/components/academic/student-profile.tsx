      ...
      {student && (
        <>
          ...
          <div className="bg-white border border-gray-200 rounded-xl p-4 space-y-2">
            ...
            <p className="text-[11px] text-gray-400">Las matrículas se gestionan en Nueva Matrícula; las notas, en Calificaciones. Sus accesos al campus viven en Aulas en Moodle.</p>
          </div>
        </>
      )}
    </div>
