...
-- PASO 1b (solo si el Nodo 7 marcó aulas con diferencia): sacarlas del lote.
-- DELETE FROM bak_nb_lote WHERE courseid IN (…ids con diferencia…);


-- ═══ PASO 2 · GUARDAS (leer; si algo no cuadra, DETENER) ═══
-- 2a · Todas siguen en media ponderada y con pesos sanos (360 filas, estado OK)
